...
import { Box, Button, Card, CardBody, Flex, HStack, Image, Spacer, Stack, Table, TableContainer, Tbody, Td, Text, Tfoot, Th, Thead, Tr, VStack } from '@chakra-ui/react'
...
const HowItWorks = () => {
    return (
        <Wrapper>
            <Container>
                <Stack as='section' padding="15px 20px">
                    ...
                    <Accordion 
                        ...
                        fontSize={['35px', '45px', '54px']}
                        color={ElementColor.green}
                        bgColor={ElementColor.transparent}
                        panel={
                            <Stack spacing={5} fontSize={['14px', '14px', '14px']} textAlign='justify'>
                                <VisaCostInfo />
                                <HStack justifyContent={'flex-end'}>
                                    <Text fontSize={['14px', '14px', '16px']}>Fees are subject to change, please use this calculator</Text>
                                </HStack>
                            </Stack>
                        }
                    />
        ...
        <Card borderRadius={'20px'}>
            <CardBody>
                <VStack alignItems={'flex-start'} spacing={'5'}>
                    <Flex width={'full'}>
                        <Box borderLeft={'3px solid'} borderColor={ElementColor.darkPrimary} padding={'0 10px'}><Text fontSize={['20px', '22px', '24px']}>Mandatory Government Fees for Green Cards</Text></Box>
                        <Spacer />
